...
// var savedContent = localStorage.getItem("saved-content")
//     ? JSON.parse(localStorage.getItem("saved-content"))
//     : [];
...
// function getYoutubeContent(value) {
//   var queryUrl = `https://www.googleapis.com/youtube/v3/search?key=${ytAPIkey}&q=${value}&maxResults=50&type=video&videoEmbeddable=true`;
//   fetch(queryUrl)
//     .then(function (response) {
//       return response.json();
//     })
